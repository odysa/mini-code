...
Open `mini-code-starter/src/tools/bash.rs`.
...
Open `mini-code-starter/src/tools/write.rs`.
...
Open `mini-code-starter/src/tools/edit.rs`.
...
```bash
cargo test -p mini-code-starter ch4
```
